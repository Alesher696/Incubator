...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): AffairType[] => { // need to fix any
    ...
    let affairsFilter = affairs.filter(aff => filter === aff.priority)
    let result = (filter === "low") ?
        affairsFilter : (filter === "middle") ?
            affairsFilter : (filter === "high") ?
                affairsFilter : affairs
    return result
}
